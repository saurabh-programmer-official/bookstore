...
public BookInfo getBookByBookId(int bookId) {
	...
	System.out.println("bookInfo executed: ");
	return book; 
}
...
*/
	...
	BookInfo book=bookSearchProxy.getBookInfoById(bookId);
	return book;
}
...
*/
		...
		double offerPrice =bookPriceProxy.getBookOfferPrice(bookId); 
	//			bookSearchProxy.getBookOfferPrice(bookId);
				//

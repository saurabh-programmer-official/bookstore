...
@ApiModel(value = "Book Price entity class which contains BookId, Price, Offer and ServerPort")
public class BookPriceInfo {


	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "bookId_generator")
	@SequenceGenerator(name="bookId_generator", sequenceName = "mybookId_gen",initialValue = 122,allocationSize = 1)
	@ApiModelProperty("holds Bookd Id")
	@Column(name="book_id")
	private int bookId;
